...
public class FileProcess {
	...
	public static final String PATH = "../../../data/union_lda_input/";
//	public static  String DATA_DIR="../../../data/lda_input_steps_to_perform/";
//	public static  String OUTPUT_PATH="../../../data/fault_matrix/"+steps+"/";
	public static  String DATA_DIR="../../../data/union_lda_input";
	public static  String OUTPUT_PATH="../../../data/union_fault_matrix/"+steps+"/";
