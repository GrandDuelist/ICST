...
public class FileProcess {
	...
	public static final String PATH = "../../../data/lda_input_steps_to_perform/litmus70/";
	public static final String DATA_DIR="../../../data/lda_input_steps_to_perform/";
	public static final String OUTPUT_PATH="../../../data/fault_matrix/"+steps+"/";
			;
